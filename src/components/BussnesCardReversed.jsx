...
const BussnesCardReversed = ({title,desc,img}) => {

  return (
    <motion.div initial={{ x: 250, opacity: 0, scale: 0.5 }}
    whileInView={{ x: 0, opacity: 1, scale: 1 }} viewport={{ once: true }}
    transition={{ duration: 0.5, type: 'easeInOut' }} className='flex my-24 h-auto lg:h-[520px] flex-col w-full lg:flex-row items-center justify-center'>
